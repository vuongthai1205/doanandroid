...
//                }
//
//                // Kiểm tra tên đăng nhập không trống và không phải hợp lệ
...
//                {
//                    Toast.makeText(getApplicationContext(), "Tên đăng nhập không được có khoảng cách",Toast.LENGTH_SHORT ).show();
//                    return;
//                }
//                // Họ và tên người dùng không được trốngv
...
//                    Toast.makeText(SignupActivity.this, "Số điện thoại không được trống và phải hợp lệ", Toast.LENGTH_SHORT).show();
//                    return;
...
//                    return;
//                }
//                // Kiểm tra email phải hợp lệ và không được trống
...
//                    return;
//                }
//                // Kiểm tra mật khẩu hợp lệ không được trống và hợp lệ
//                if (TextUtils.isEmpty(password) || password.length() < 5) {
//                    Toast.makeText(SignupActivity.this, "Mật khẩu phải có ít nhất 5 kí tự", Toast.LENGTH_SHORT).show();
//                    return;
//                }
//                // Kiểm tra ô nhập lại mật khẩu hợp lệ không được trống
